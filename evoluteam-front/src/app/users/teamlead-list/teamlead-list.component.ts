...
@Component({
  selector: 'app-teamlead-list',
  templateUrl: './teamlead-list.component.html',
  styleUrls: ['./teamlead-list.component.scss']
})
export class TeamleadListComponent implements OnInit {
  ...
  loadUsers(): void {
    ...
    this.userService.getAllUsers().subscribe({
      next: (users) => {
        this.users = users; // Assuming team leads can see all users
        this.loading = false;
      },
      error: (error) => {
        this.loading = false;
